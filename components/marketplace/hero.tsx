...
export function Hero() {
  return (
    <section className="relative flex w-full flex-col items-center border-b border-[rgba(55,50,47,0.12)] pb-11 text-center">
      <div className="z-10 flex max-w-3xl flex-col items-center px-6">
        ...
        <h1 className="font-serif text-[42px] leading-[1.02] tracking-[-0.04em] text-[#111] sm:text-[58px] lg:text-[64px]">Steal customers from your competitors.</h1>
